...
from tests.platformcompat.plugins.host_info.memory import MemoryCollector
from tests.platformcompat.plugins.host_info.os_c import OSCollector
from tests.platformcompat.plugins.host_info.cpu import CpuCollector
from tests.platformcompat.plugins.host_info.disk import DiskCollector
from tests.platformcompat.plugins.host_info.iops import IopsCollector
